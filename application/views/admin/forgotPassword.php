    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            ...
            <div class="login-box-body">
                ...
                <form role="form" method="post" class="validateForm" action="<?= base_url() ?>admin/admin/forgotPassword">
...
<p></p>
                    <div class="row">
                        ...
                        <div class="col-xs-12 text-center">
                            <a href="<?= base_url()?>admin/admin/" class="btn btn-primary btn-block btn-flat">Back </a>
                        </div>
                        <!-- /.col -->
                    </div>
