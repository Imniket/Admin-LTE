                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="kv-avatar center-block text-center" style="width:200px">
                                    ...
                                    $url = "";
                                    if ($user['profile'] != "") {
                                        $url = 'data-preview = "' . base_url() . 'uploads/users/thumb/' . $user['profile'] . '"';
                                    }
                                    ?>
                                    <input id="avatar-1" <?= $url ?> name="profile" type="file" class="file-loading">
                                    <div class="help-block"><small>Select file < 2500 KB</small> <br/>((Dimensions Height:<b>100px</b> & Width:<b>100px</b>)) </div>
                                </div>
