...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a class="active">User Match </a></li>
    </ol>
</section>
...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            <!-- <a href="<?= base_url() ?>admin/matchuser/add" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> &nbsp;&nbsp;Match User</a> -->
        </div>
    </div>
    <br>
    <div class="row">
        <div class="col-xs-12">
            ...
            <script type="text/javascript"> 
                ...
                function userSearch() {
                    ...
                    showLoadingBar();
                    var ajaxUrl = "<?php echo base_url() ?>admin/usermatch/matchList";
