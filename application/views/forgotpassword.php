    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            <div class="login-logo">
                <a href="javascript:void(0)"><?=APP_NAME?>
                    <!--<img src="<?= base_url() . 'themes/adminLte/dist/img/logo_mail.png' ?>" width="250" >-->
                    </a>
            </div>
            <!-- /.login-logo -->
            <div class="login-box-body">
                ...
                <form role="form" method="post" class="validateForm" action="<?= base_url() ?>forgotpassword">
                    <input type="hidden" value="<?= $_GET['for']; ?>" name="emailId" />
                    <div class="form-group has-feedback">
                        <input type="password" name="forgotPassword" id="forgotPassword" class="form-control" placeholder="Password" required="required">
